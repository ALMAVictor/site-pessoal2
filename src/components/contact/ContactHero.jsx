...
import { FaRocket, FaHandshake, FaBolt } from 'react-icons/fa';
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/20 backdrop-blur-sm border border-blue-400/30 mb-6">
            <FaHandshake className="text-blue-300" size={16} />
            <span className="text-sm font-semibold text-blue-200">Let's Work Together</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-blue-200/90 mb-4 max-w-3xl mx-auto leading-relaxed">
            Whether it's high-converting landing pages, a complete customer acquisition ecosystem, or CRO optimization—I deliver end-to-end solutions that translate consumer behavior into measurable revenue.
          </p>

          <p className="text-base md:text-lg text-blue-300/80 mb-12 max-w-2xl mx-auto">
            Connect with me on LinkedIn and I'll get back to you within <strong className="text-white">24 hours</strong>.
          </p>

          {/* Quick benefits */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              { Icon: FaRocket, label: 'Fast Response', value: '24 Hours' },
              { Icon: FaHandshake, label: 'Free Consultation', value: 'Strategy Call' },
              { Icon: FaBolt, label: 'Quick Start', value: 'Ready to Go' },
            ].map((stat) => (
              <div
                key={stat.label}
                className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-colors"
              >
                <div className={`mx-auto mb-3 w-8 h-8 flex items-center justify-center bg-gradient-to-br ${stat.label === 'Fast Response' ? 'from-blue-400 to-cyan-400' : stat.label === 'Free Consultation' ? 'from-green-400 to-emerald-400' : 'from-orange-400 to-red-400'} rounded-lg`}>
