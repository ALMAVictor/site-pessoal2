...
export const projectsData = [
  ...
  },
  {
    ...
    category: 'landing',
    market: 'us', // US market
    description: 'Designed, programmed (Next.js/React), and optimized multiple landing pages for Paid Traffic campaigns (Meta/Google Ads). Applied consumer behavioral psychology principles and A/B testing strategies.',
  ...
  },
  {
    ...
    category: 'sites',
    market: 'us', // US market
    description: 'Led platform A/B testing strategy, applying consumer behavioral psychology principles and rewriting UI copywriting. Implemented Growth tool stack for end-to-end funnel analysis.',
    fullDescription: 'Comprehensive CRO platform with built-in A/B testing infrastructure. Led the strategy applying consumer behavioral psychology principles (social proof, scarcity, authority) and completely rewrote UI copywriting for maximum conversion. Implemented full Growth tool stack including Analytics, Pixels, and Hotjar for complete funnel visibility.',
    challenge: 'Optimize user activation and retention through data-driven A/B testing and consumer behavioral psychology application.',
    solution: 'Created a React/TypeScript component library with A/B testing capabilities, integrated comprehensive analytics stack, and applied consumer behavioral psychology principles to UI/UX design and copywriting.',
    duration: '8 weeks',
